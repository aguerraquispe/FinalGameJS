...
var Nivel1 = {
	...
	create: function () {
		...
		this.sonidoanimal = this.sound.add('sonidoanimal');
...
var Nivel2 = {
	preload: function () {
		juego.load.image('nave', 'img/personaje.png');
		juego.load.image('laser', 'img/comida_carne.png');
		juego.load.image('malo', 'img/a_nivel2.png');
		juego.load.image('bg', 'img/bgnivel2.png');
		juego.load.image('over', 'img/over.jpg');

		this.load.audio('sonido', 'audio/lanzar.mp3');
		this.load.audio('sonidoanimal', 'audio/sound_condor.mp3');
		this.load.audio('ost', 'audio/sound_sierra.mp3');
		this.load.audio('finjuego', 'audio/final.mp3');
	},
...
var Nivel3 = {
	preload: function () {
		juego.load.image('nave', 'img/personaje.png');
		juego.load.image('laser', 'img/comida_semillas.png');
		juego.load.image('malo', 'img/a_nivel3.png');
		juego.load.image('bg', 'img/bg2nivel1.png');
		juego.load.image('over', 'img/over.jpg');

		this.load.audio('sonido', 'audio/lanzar.mp3');
		this.load.audio('sonidoanimal', 'audio/sound_tapir.mp3');
		this.load.audio('ost', 'audio/sound_costa.mp3');
		this.load.audio('finjuego', 'audio/final.mp3');
	},
	...
	create: function () {
		...
		//definiendo el puntaje en pantalla
		puntos = 20;
		juego.add.text(20, 20, "Nivel 3 - Puntos: ", { font: "18px Arial", fill: "#000" });
		txtPuntos = juego.add.text(160, 20, puntos, { font: "18px Arial", fill: "#000" });
...
var Nivel4 = {
	preload: function () {
		juego.load.image('nave', 'img/personaje.png');
		juego.load.image('laser', 'img/comida_bananas.png');
		juego.load.image('malo', 'img/a_nivel4.png');
		juego.load.image('bg', 'img/bgnivel4.png');
		juego.load.image('over', 'img/over.jpg');

		this.load.audio('sonido', 'audio/lanzar.mp3');
		this.load.audio('sonidoanimal', 'audio/sound_mono.mp3');
		this.load.audio('ost', 'audio/sound_selva.mp3');
		this.load.audio('finjuego', 'audio/final.mp3');
	},
