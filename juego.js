...
var Nivel1 = {
	...
	create: function () {
		...
		puntos = 0;
		juego.add.text(20, 20, "Nivel 1 - Puntos: ", { font: "14px Arial", fill: "#fff" });
		txtPuntos = juego.add.text(130, 20, "0", { font: "14px Arial", fill: "#fff" });
...
var Nivel2 = {
	...
	create: function () {
		...
		//definiendo el puntaje en pantalla
		puntos = 5;
		juego.add.text(20, 20, "Nivel 2 - Puntos: ", { font: "14px Arial", fill: "#fff" });
		txtPuntos = juego.add.text(130, 20, puntos, { font: "14px Arial", fill: "#fff" });

		//definir contador de vidas
		vidas = 3;
		juego.add.text(310, 20, "Vidas: ", { font: "14px Arial", fill: "#fff" });
		txtVidas = juego.add.text(360, 20, "♥ ♥ ♥", { font: "14px Arial", fill: "#fff" });
